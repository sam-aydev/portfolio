    ...
    return(
        <div>
            <div className="sm:flex sm:justify-between">
                <div>
                    <p className="font-semibold text-center text-[23px] font-mono">sam-aydev</p>
                </div>
            ...
            <div className="sm:flex sm:flex-row-reverse sm:space-x-4 sm:mt-10">
                ...
                <div className="flex mt-3 flex-col sm:w-1/2 sm:px-3">
                    ...
                    Nice to meet you!<br/>
                    I'm <span className="underline text-green-600">
                        Adetunji Samuel
                        </span>.
                    </p>
                    <p className="text-center mt-5 text-slate-500 font-medium sm:text-left lg:text-xl">Based in Nigeria. I am a
                    full-stack developer with <b>5 years of experience</b>, I enjoy building complex app for both the frontend and
                    backend, with a primary aim to improve users experience on any software.
                    </p>
                    <div className="mt-5 flex flex-col sm:flex-row sm:space-x-4 sm:space-y-0 space-y-3">
                        ...
                        <Link href="/MY CV .pdf" locale={false} className=" 
                        border-b-2 
                        border-b-green-600 
                        font-medium
                        py-2
